      ...
      <div className="container">
        <div className="text-center mb-12">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                Kami memberikan lebih dari sekadar mobil. Kami memberikan kepastian, keamanan, dan kenyamanan untuk setiap rental mobil di Medan.
            </p>
        </div>
        <ul className="grid grid-cols-1 grid-rows-none gap-8 md:grid-cols-2 lg:grid-cols-3">
          <GridItem
            ...
            description="Tidak ada biaya tersembunyi. Dapatkan harga sewa mobil Medan murah, jujur, dan bersaing."
          />
          <GridItem
          ...
          <GridItem
            ...
            description="Layanan antar-jemput di bandara, hotel, atau lokasi pilihan Anda di Medan untuk kemudahan maksimal."
          />
        </ul>
      </div>
    </section>
