...
const servicesList = [
  ...
  },
  {
    ...
    title: "Antar-Jemput Bandara Kualanamu & Silangit",
    description:
      "Layanan rental mobil dari dan ke Bandara Kualanamu atau Silangit dengan penjemputan yang tepat waktu.",
    features: [
  ...
  },
  {
    ...
    description:
      "Nikmati kebebasan penuh menjelajahi kota dengan sistem sewa mobil lepas kunci Medan yang mudah dan aman.",
    features: [
...
const phoneNumber = "6281396565157";
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
              Kami menawarkan berbagai layanan rental mobil di Medan yang
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {servicesList.map((service, index) => {
              const message = `Halo, saya tertarik dengan layanan '${service.title}' dari CV BOY MAKMUR JAYA. Bisa jelaskan lebih detail?`;
