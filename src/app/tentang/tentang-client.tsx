...
export function TentangPageClient() {
  ...
  const teamImageUrl = "/tentang1.jpeg";
  const fleetImageUrl = "/tentang/tentang2.webp";
        ...
        <div className="container grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="grid grid-cols-2 gap-4 animate-fade-in-up">
            ...
            >
              <Image
                src={teamImageUrl}
                alt="Tim CV BOY MAKMUR JAYA di depan kantor Medan"
            ...
            >
              <Image
                src={fleetImageUrl}
                alt="Armada mobil CV BOY MAKMUR JAYA"
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground">
              Selamat Datang di CV BOY MAKMUR JAYA
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Kami adalah partner terpercaya untuk semua kebutuhan transportasi
              Anda di Medan dan sekitarnya. Dengan komitmen pada kualitas,
