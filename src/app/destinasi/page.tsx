...
const destinations = [
  ...
  },
  {
    title: "Istana Maimun",
    description:
      "Ikon Kota Medan, istana Kesultanan Deli ini memadukan arsitektur Melayu, Islam, dan Eropa. Kenali sejarah kota melalui kemegahan istana ini.",
    imageUrl: "/destinasi/destinasi3.webp",
    imageHint: "maimun palace architecture",
    mapsUrl: "https://maps.app.goo.gl/DicqTpMZy7Bec3Ty5",
  },
  {
    title: "Masjid Raya Al-Mashun",
    description:
      "Masjid Agung Medan yang megah dengan arsitektur oktagonal yang unik. Sebuah simbol keharmonisan dan peninggalan sejarah Kesultanan Deli.",
    imageUrl: "/destinasi/destinasi5.webp",
    imageHint: "grand mosque medan",
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground md:text-4xl">
              Jelajahi Pesona Medan & Sekitarnya
            </h2>
